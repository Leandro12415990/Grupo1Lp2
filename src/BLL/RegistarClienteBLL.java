...
public class RegistarClienteBLL {
    ...
    public static boolean criarCliente(String nome, String email, LocalDate nascimento, String morada, String password)
    {
        ...
        try {
            utilizador = new Utilizador( max + 1, nome, email, nascimento, morada, password, hora, hora, Tools.tipoUtilizador.CLIENTE.getCodigo(), Tools.estadoUtilizador.PENDENTE.getCodigo());
        } catch (Exception e) {
            return false;
        }
